...
const services = [
  {
    ...
    description:
      "Building dynamic, responsive, and efficient web solutions with a focus on performance and user experience.",
  },
  {
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <div className="space-y-12">
            <motion.h2 variants={fadeInUp} className="text-5xl font-bold text-center text-[#000]">
              My Service
            </motion.h2>
              ...
              {services.map((service) => (
                ...
                >
                  <div className="flex items-start space-x-4">
                    <div className="text-[#FFB800]">{service.icon}</div>
